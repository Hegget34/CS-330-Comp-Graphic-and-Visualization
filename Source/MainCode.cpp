...
namespace
{
	...
	const char* const WINDOW_TITLE = "CS-330 Milestone Three - 3D Scene with Camera Navigation";
...
int main(int argc, char* argv[])
{
	...
	std::cout << "CS-330 Milestone Three - 3D Scene with Camera Navigation" << std::endl;
	std::cout << "=====================================================" << std::endl;
	std::cout << "Camera Controls:" << std::endl;
	std::cout << "  WASD - Move forward, backward, left, right" << std::endl;
	std::cout << "  Q/E  - Move up and down" << std::endl;
	std::cout << "  Mouse - Look around" << std::endl;
	std::cout << "  Mouse wheel - Adjust movement speed" << std::endl;
	std::cout << "  1-4  - Switch between camera presets" << std::endl;
	std::cout << "  P - Switch to perspective view" << std::endl;
	std::cout << "  O - Switch to orthographic view" << std::endl;
